...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (matlab-mode uimage org-bullets monochrome-theme ein virtualenvwrapper diminish elpy dumb-jump flx-ido projectile swiper spaceline company popwin smartparens markdown-mode exec-path-from-shell flycheck)))
