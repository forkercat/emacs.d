...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (nyan-mode ido-vertical-mode popup-kill-ring company-irony hide-lines yasnippet-snippets company popwin smartparens markdown-mode exec-path-from-shell flycheck)))
